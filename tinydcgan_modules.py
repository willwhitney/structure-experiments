...
class DeterministicTinyDCGANFirstInference(nn.Module):
    def __init__(self, input_dims, hidden_dim):
        super(DeterministicTinyDCGANFirstInference, self).__init__()
        self.input_dims = input_dims
        self.hidden_dim = hidden_dim
...
class DeterministicTinyDCGANInference(nn.Module):
    def __init__(self, input_dims, hidden_dim):
        super(DeterministicTinyDCGANInference, self).__init__()
        self.input_dims = input_dims
        self.hidden_dim = hidden_dim
    ...
    def forward(self, x_t):
        ...
        new_hidden = activation(self.merged_lin(current))
...
class DeterministicTinyDCGANGenerator(nn.Module):
    def __init__(self, hidden_dim, output_dims):
        super(DeterministicTinyDCGANGenerator, self).__init__()
        self.hidden_dim = hidden_dim
        self.output_dims = output_dims
